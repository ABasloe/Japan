...
("Royal Palace + Campo del Moro",40.4180,-3.7143,12,"attraction","Madrid",
 "4:00 PM Royal Palace (10-min walk). 🇪🇸 Friends say approach from below via Campo del Moro / Cuesta de la Vega (where Day 14's Muralla Árabe sits) — flat frontal view has 'no depth'. Then walk across to the Prado for its free 18:00–20:00 window (next stop).",
 None,16,90,False),
("⭐ Museo del Prado",40.4138,-3.6921,12,"museum","Madrid",
 "⭐ 6:00 PM the Prado in its free window (Mon–Sat 18:00–20:00) — skip the ticket line and go straight for the greatest hits: Velázquez's Las Meninas, Goya's black paintings, Bosch's Garden of Earthly Delights. A focused ~1.5-hr loop, then stroll back down to Plaza Mayor for dinner. This is the free slot the Royal Palace note flags; the Reina Sofía on Day 14 is its modern counterpart on the same Paseo del Prado art axis.",
 "https://www.museodelprado.es/en",18,105,False),
("La Casa del Abuelo 🦐",40.4165,-3.7018,12,"food","Madrid",
 "🦐 Gambas al ajillo since 1906 — the sizzling garlic-shrimp tapa Anthony Bourdain came for, at the standing-room original off Puerta del Sol. Pair it with a chato of sweet 'vino del abuelo,' ~€12–15. Right on the walk back from the Prado to Plaza Mayor for dinner.",
 None,20,20,False),
